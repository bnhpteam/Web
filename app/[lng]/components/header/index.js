...
export const Header = () => {
    ...
    const isHome = pathName === `/${currentLng}` || pathName === `/${currentLng}/`;
    const isPageActive = (href) => pathName.includes(href);
            ...
            <header className='w-screen h-[56px] fixed top-0 left-0 z-[999] bg-[#101010] border-b border-[#2B2B2B] max-yt:px-[10px]'>
                <div className='max-w-[1280px] w-full mx-auto h-full border-l border-r border-[#2B2B2B] flex items-center justify-between px-6'>
                    ...
                    <div className='flex items-center gap-x-5'>
                        ...
                        <a
                            href='/'
                            className={`whitespace-nowrap text-[14px] ease-out duration-[.2s] cursor-pointer hover:!text-white ${isHome ? '!text-white' : 'text-[rgba(255,255,255,0.4)]'}`}
                        >
